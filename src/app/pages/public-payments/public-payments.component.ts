...
@Component({
  ...
  template: `
    <!-- Public header (no navbar) -->
    <div class="pub-header">
      <div class="pub-brand">
        <mat-icon>sports_baseball</mat-icon>
        <span>Baseball Stats</span>
      </div>
      <div class="pub-title">Reporte del Fondo</div>
      <span class="pub-badge">Vista Pública</span>
    </div>
        ...
        <mat-tab>
          ...
          <div class="tab-content">
            <p class="tab-info">
              ...
              Semana <strong>{{ weeksOwedNow() }}</strong> de temporada &nbsp;·&nbsp;
              Cada jugador debería haber pagado <strong>\${{ totalOwedNow() }} DOP</strong>
            </p>
            <div class="players-grid">
              @for (s of playerSummaries(); track s.player.id) {
                <mat-card
                  ...
                  [class.card-pending]="s.debtAmount > 0 && s.totalPaid > 0"
                  [class.card-zero]="s.totalPaid === 0">
                  <mat-card-content>
                    <div class="pp-header">
                    ...
                    <div class="pp-status"
                         ...
                         [class.status-pending]="s.debtAmount > 0"
                         [class.status-zero]="s.totalPaid === 0">
                      @if (s.totalPaid === 0) {
  ...
  styles: [`
    ...
    .pub-brand {
      ...
      color: white; font-size: 1.1rem; font-weight: 700; margin-right: auto;
    }
    .pub-brand mat-icon { color: #EF5350; }
    .pub-title { color: rgba(255,255,255,0.9); font-size: 0.95rem; font-weight: 500; }
    .pub-badge {
    ...
    .summary-card { flex: 1; min-width: 150px; border-radius: 12px !important; }
    ...
    .list-item { display: flex; padding: 10px 4px; border-bottom: 1px solid #f0f0f0; }
    .li-body { flex: 1; }
    ...
    @media (max-width: 600px) {
      .pub-header { padding: 0 12px; }
      .pub-title { display: none; }
...
export class PublicPaymentsComponent implements OnInit {
